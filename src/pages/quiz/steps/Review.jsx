...
import { generateMockPlan } from '../../../data/mockData';
  ...
  async function handleGenerate() {
    ...
    try {
      ...
      try {
        ...
        // Fallback to mock if API fails (e.g. 404, network error, offline)
        console.warn('Backend unavailable, using mock plan:', apiError);
        data = generateMockPlan(answers);
      }
